...
//-----------------------------------------------------------------------------
// - You generally do NOT need to care or use this ever. But we need to make it available in imgui/imgui.h because some of our public structures are relying on it.
...
// Include imgui_user.h at the end of imgui/imgui.h (convenient for user to only explicitly include vanilla imgui/imgui.h)
